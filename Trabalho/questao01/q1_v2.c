...
void *leitor(void *t) {
    /*
    Usei o useep para o processo peder a cpu, mas ao invés de perder por segundos, perde por microsegundos
    assim é possível ver a leitura suja.
    */
    long tid = (long)t;
...
void *escritor(void *t) {
    ...
    /*
    Aqui usei semafaro para impedir que vários escritores alterassem a variável ao mesmo tempo.
...
int main(int argc, char *argv[]) {
    ...
    for (t = 0; t < NUM_THREADS; t++) {
        ...
        /*
        A linha abaixo é para tentar trazer um fator aleátorio na criação das threads
        */
